#!/usr/bin/env python3
"""
DEPRECATED for gold — use v15/backtest/backtest_v15.py (matches live v15 bot).

Kept for oil subprocess backtests (V14_PRICE_TABLE=prices) and WF time-filter rebuild.
Gold backtests: run_pattern_backtest.py or v15/backtest/backtest_v15.py

Usage:
  python3 backtest_patterns_v14.py 2025-06-01 2026-05-23
  V14_TIME_FILTER_JSON=runtime/hybrid_weak_time_slots.json python3 backtest_patterns_v14.py
"""
...
from backtest.core import simulate_hybrid_core, simulate_hybrid_two_pass, simulate_v13_core
...
out_path = (PROJECT_ROOT / _out) if _out else PROJECT_ROOT / "runtime" / "oil_pattern_backtest_trades.csv"

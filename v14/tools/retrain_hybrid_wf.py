...
3. Rebuild runtime/v14_weak_time_slots.json from those trades.
...
Usage:
  PYTHONPATH=. .venv/bin/python3 v14/tools/retrain_hybrid_wf.py
  PYTHONPATH=. .venv/bin/python3 v14/tools/retrain_hybrid_wf.py 2025-06-01 2026-05-23
  V14_WF_TRAIN_MODE=full .venv/bin/python3 v14/tools/retrain_hybrid_wf.py  # bootstrap all cycles
"""
...
from v14.tools import run_hybrid_time_filter as rhtf

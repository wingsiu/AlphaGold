...
class BotConfig:
	...
	weak_periods_json: Optional[str] = "runtime/bot_assets/weak_periods_best_base_v2.json"
...
def build_parser() -> argparse.ArgumentParser:
	...
	p.add_argument("--weak-periods-json", default="runtime/bot_assets/weak_periods_best_base_v2.json",
		help="Optional weak-period cells JSON to block entries in weak hours (default: runtime/bot_assets/weak_periods_best_base_v2.json).")

...
# Near-Config-C follow-up under next-bar-open execution:
# - keep Config C flat-ratio sweep: 3.0, 4.0, 5.0
# - switch to r0-style filter: min-15m-rise = 0
# - sweep stage1 around the stronger C-family region: 0.50, 0.55, 0.60
# - sweep directional stage2 gates near Config C's 0.62 / 0.64
# - preserve the original near-C script as the rise=15 control

MODEL_OUT="training/_wfC_r0_nearC_flat345_s150_60_u60_64_d62_66.joblib"
REPORT_OUT="training/_wfC_r0_nearC_flat345_s150_60_u60_64_d62_66.json"
TRADES_OUT="training/_wfC_r0_nearC_flat345_s150_60_u60_64_d62_66.csv"

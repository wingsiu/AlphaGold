...
# - keep the r0 family (min-15m-rise = 0)
# - restore Config C flat-ratio sweep: 3.0, 4.0, 5.0
# - still sweep stage1 and directional stage2 gates
# - avoid the loosest directional values from the last over-aggressive run

MODEL_OUT="training/_wfC_r0_flat345_s148_55_u56_62_d62_66.joblib"
REPORT_OUT="training/_wfC_r0_flat345_s148_55_u56_62_d62_66.json"
TRADES_OUT="training/_wfC_r0_flat345_s148_55_u56_62_d62_66.csv"
...
python3 -u training/image_trend_ml.py \
  ...
  --wf-sweep-flat-ratios 3.0,3.5,4.5 \
